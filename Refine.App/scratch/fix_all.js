...
// 1. Replace exercises List with oldNameToExercise Dictionary
// We need to match from `var exercises = new List<Exercise>` down to `await _connection!.InsertAllAsync(exercises);`
const startIdx = content.indexOf('var exercises = new List<Exercise>');
const endIdx = content.indexOf('await _connection!.InsertAllAsync(exercises);') + 'await _connection!.InsertAllAsync(exercises);'.length;
